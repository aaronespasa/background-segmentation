...
def get_model(encoder, decoder, encoder_weights_dataset="imagenet", num_classes=1, in_channels=3):
    ...
    Args:
        - encoder (str): Encoder name. Must be one of ['mit_b0', 'mit_b1', 'mit_b2', 'mit_b3', 'mit_b4', 'mit_b5', 'resnet34'].
        - decoder (str): Decoder type. Must be one of ['fpn', 'unet', 'unet++', 'manet', 'deeplabv3'].
    """
